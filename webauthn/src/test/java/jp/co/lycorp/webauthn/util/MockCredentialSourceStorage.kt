...
package jp.co.lycorp.webauthn.util
...
class MockCredentialSourceStorage : CredentialSourceStorage {
    ...
    override fun store(credSource: jp.co.lycorp.webauthn.model.PublicKeyCredentialSource) {
    ...
    override fun load(credId: String): jp.co.lycorp.webauthn.model.PublicKeyCredentialSource? {
