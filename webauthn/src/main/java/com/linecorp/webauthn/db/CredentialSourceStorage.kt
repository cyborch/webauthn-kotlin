...
package com.linecorp.webauthn.db
...
interface CredentialSourceStorage {
     ...
     */
    fun store(credSource: com.linecorp.webauthn.model.PublicKeyCredentialSource)
     ...
     */
    fun load(credId: String): com.linecorp.webauthn.model.PublicKeyCredentialSource?
     ...
     */
    fun loadAll(aaguid: UUID? = null): List<com.linecorp.webauthn.model.PublicKeyCredentialSource>
