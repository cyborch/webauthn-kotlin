...
class Fido2KeyGeneratorTest {
    ...
    private fun testKeyGenerator(keyGenerator: com.linecorp.webauthn.authenticator.keygenerator.Fido2KeyGenerator) {
    ...
    fun testBiometricKeyGeneratorGenerateFido2Key() {
        val keyGenerator = com.linecorp.webauthn.authenticator.keygenerator.BiometricKeyGenerator()
    ...
    fun testDeviceCredentialKeyGeneratorGenerateFido2Key() {
        val keyGenerator =
            com.linecorp.webauthn.authenticator.keygenerator.DeviceCredentialKeyGenerator()
        testKeyGenerator(keyGenerator)
    }
